 ...
 *
 * @returns The core table name (e.g., "ledgerfit-core-dev")
 ...
 *
 * @returns The base table name (e.g., "ledgerfit-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "ledgerfit-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "ledgerfit-app-realtime-dev")
