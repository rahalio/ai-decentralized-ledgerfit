/**
 * Training Services - Application Layer Export
 *
...
/**
 * Training Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for training domain.
 */
